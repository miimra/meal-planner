...
remote_host="${DEPLOY_HOST:-raptor@printer-server.local}"
remote_path="${DEPLOY_PATH:-/home/raptor/meal-planner}"
public_health_url="${DEPLOY_HEALTH_URL:-https://meal.number34.nl/api/health}"
